          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <input className="w-full bg-[#F3F3F3] rounded px-4 py-3 text-black outline-none text-[15px]" placeholder="Select Blocked By" value={form.blockedBy} onChange={handleDetailedChange} />
              </div>
            </div>
          </div>
