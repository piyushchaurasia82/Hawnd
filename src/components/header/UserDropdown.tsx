...
export default function UserDropdown() {
  ...
  // Blur sidebar toggle when modal is open/closed
  useEffect(() => {
    if (window.setBlurSidebarToggle) {
      window.setBlurSidebarToggle(false);
    }
  }, []);
    ...
    <div className="relative">
      ...
      >
        <span className="block mr-1 font-medium text-theme-sm">
          {user ? (
            <span
              className="h-8 min-w-[2.5rem] px-3 rounded-full flex items-center justify-center font-bold text-base"
              style={{
                background: 'transparent',
                color: '#7393B3', // Tailwind gray-100
                boxShadow: '0 0 0 4px #FFAC1C', // orange-100
              }}
            >
