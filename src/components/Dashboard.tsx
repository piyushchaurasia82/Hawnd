    ...
    <div className="p-4 sm:p-8 bg-[#FAFAFA] min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="md:col-span-2 bg-white rounded-xl shadow p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 mb-4">
            <select
              className="px-3 py-2 rounded border border-gray-200 text-sm w-full sm:w-auto"
            ...
            <select
              className="sm:ml-2 px-3 py-2 rounded border border-gray-200 text-sm w-full sm:w-auto mt-2 sm:mt-0"
              value={graphRange}
      ...
      <div className="bg-white rounded-xl shadow p-4 sm:p-6 mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 mb-4">
          ...
          <select
            className="sm:ml-2 px-4 py-1 rounded-full bg-gray-100 text-gray-700 font-semibold w-full sm:w-auto mt-2 sm:mt-0"
